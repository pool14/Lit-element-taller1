...
export class Index3 extends LitElement {
  ...
  render() {
    const users = [
      { id: 1, name: "Mtfest", campaña: "Motor fest", user: "0", director: "Juan perez" },
      { id: 2, name: "Tjp ", campaña: "Tuning japones", user: "2", director: "" },
      { id: 3, name: "Ame ", campaña: "Americanos", user: "3", director: ""},
    ];
        ...
        <div class="pt-2 d-flex justify-content-left ">
          <div class="d-flex  flex-shrink-0 p-3 ml-5" style="width: 250px; background-color: rgb(201, 205, 207); border-radius: 1rem; height: 42.4rem;">
            ...
            <ul class="nav nav-pills flex-column mb-auto" style="width: 25rem;">
              ...
              <li class="nav-item pt-3">
                <button ${() => renderPage('index3')}" class="nav-link active bg-light pt-2 font-weight-bold" style="color: grey; border-radius: 10px; height: 45px; width: 13.5rem; font-size: 18px;" aria-current="page">
              ...
              <div>
                <div class="d-flex justify-content-around ">
                  ...
                  <div class="d-flex justify-content-right ml-5">
                    <button class="mt-1 text-center" style=" width: 5rem; height: 50px; border-radius: 5px;  background-color: #E7E7E7; color: black;">
                ...
                <div class="container border border-dark mt-4 ml-4" style="border-radius: 1rem; width: 38rem; height: 28.5rem">
                  ...
                  <div class="user-container user-titles border border-dark mt-4 ml-4" style="border-radius: 1rem; width: 32rem; height: 2rem">
                    ...
                    <div class="user-column user-title">Admiten</div>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <div class="user-column user-title">Director</div>
                    ...
                    ${users.map((user) => html`
                      <li>
                        <div class="user-container">
                          ...
                          <div class="user-column mt-4 ml-4" style="width: 32rem; height: 5rem">${user.campaña}</div>
                          <div class="user-column mt-4 ml-4" style="width: 32rem; height: 5rem">${user.user}</div>
                          <div class="user-column mt-4 ml-4" style="width: 32rem; height: 5rem">${user.director}</div>
...
customElements.define("index-3-component", Index3);
